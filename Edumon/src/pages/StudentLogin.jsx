...
const StudentLogin = () => {
  ...
  return (
    ...
    <h2 className="absolute top-5 left-5 text-green-600 text-lg">
      ...
      <h1 className='text-4xl text-green-600 font-bold'>Login as Student</h1>
      <form  
      ...
      className="w-1/2 flex flex-col p-6 gap-5 bg-green-50 rounded-xl shadow-[0px_0px_12px_rgba(0,0,0,0.20)] z-10 md:w-1/4 ">
        ...
        className="w-[90%]  rounded-xl outline-none text-md px-1 py-2" />
        
        </div>
        <button 
        className=" bg-green-600 rounded-xl outline-none text-lg w-full font-semibold text-white px-5 py-2 cursor-pointer">Login</button>
      </form>
      <h2 className="text-green-600">Already have an account? <Link to={'/student/signup'} className="text-blue-600">Sign Up</Link> </h2>
    </div>
    </>
  )
}
