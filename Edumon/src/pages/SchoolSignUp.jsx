...
const SchoolSignUp = () => {
  ...
  return (
    ...
    <h1 className='text-4xl text-green-600 font-bold'>Sign Up as School</h1>
    <form 
    ...
    <h2 className="text-green-600">Already have an account? <Link to={'/school/login'} className="text-blue-600">Login</Link> </h2>
  </div>
    </>
